...
public:
  ...
  enum State
  {
    ...
    RX,
    /**
     * The PHY layer is Full-duplexing.
     */
    FD,
    /**
...
/** 
  ...
  */
  ...
  virtual Ptr<GeographyTable> GetGeographyTable (void) const = 0;
  ...
  /* original tarce */
  void NotifyRxHeaderEnd (Ptr<const Packet> packet);
...
private:
  ...
  /* original trace */
  TracedCallback<Ptr<const Packet> > m_phyRxHeaderEndTrace;

  WifiTxVector m_receivingTxVector;
  WifiPreamble m_receivingPreamble;
  Mac48Address m_receivingAddress4;
};
