 ...
 *
 * You should have received a copy of the GNwoU General Public License
...
public:
  ...
  /**
   * Return true if the header is a busytone header.
   *
   * \return if the header is a busytone header, false otherwise
   */
