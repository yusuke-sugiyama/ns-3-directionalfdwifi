...
public:
    ...
    /**
     * Set the end time of the signal.
     *
     * \param endTime the end time of the signal
     */
    void SetEndTime (Time endTime);
    /**
     * Set the address of the signal.
     *
     * \param address the address of the signal
     */
    void SetAddress (Mac48Address address);
    void SetRxPowerW (double rxPower);
    void SetStartTime (Time startTime);
    void SetPayloadMode (WifiMode payloadMode);
    void SetPreambleType (enum WifiPreamble preamble);
