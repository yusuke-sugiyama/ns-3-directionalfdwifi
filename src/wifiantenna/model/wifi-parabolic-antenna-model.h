...
#ifndef WIFI_PARABOLIC_ANTENNA_MODEL_H
#define WIFI_PARABOLIC_ANTENNA_MODEL_H
 ...
 *
 */
class WifiParabolicAntennaModel : public WifiAntennaModel
{
public:
...
#endif // WifiPARABOLIC_ANTENNA_MODEL_H
