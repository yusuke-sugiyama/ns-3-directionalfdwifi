 ...
 */
#ifndef CONSTANT_ORIENTATION_MODEL_H
#define CONSTANT_ORIENTATION_MODEL_H
 ...
 * new value.
 */
class ConstantOrientationModel : public OrientationModel
{
public:
  static TypeId GetTypeId (void);
  ConstantOrientationModel ();
  virtual ~ConstantOrientationModel ();
...
#endif /* CONSTANT_ORIENTATION_MODEL_H */
